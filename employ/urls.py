...
urlpatterns = [
    ...
    path('hr/settings/holidays/create/', require_employee_perm('hr_edit')(views.HRHolidayCreateView.as_view()), name='holiday_create'),
    ...
    path('biometric/weekly-summary/email/', require_employee_perm('hr_view')(views.BiometricWeeklySummaryEmailView.as_view()), name='biometric_weekly_summary_email'),
    ...
    path('attendance/employees/<int:pk>/decision/<str:action>/', require_employee_perm('hr_edit')(views.EmployeeAttendanceEmailDecisionView.as_view()), name='attendance_email_decision'),
    ...
    path('payroll/employee/<int:pk>/slip/', require_employee_perm('hr_salary')(views.EmployeePayrollSlipView.as_view()), name='employee_payroll_slip'),
