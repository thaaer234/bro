...
urlpatterns = [
    ...
    path('<int:student_id>/print-registration-form/', require_employee_perm('students_profile')(views.print_registration_form), name='print_registration_form'),
    path('<int:student_id>/staff-notes/add/', require_employee_perm('students_edit')(views.add_student_staff_note), name='add_staff_note'),
