    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost_center_type', models.CharField(choices=[('ACADEMIC', 'أكاديمي / Academic'), ('ADMINISTRATIVE', 'إداري / Administrative'), ('OPERATIONAL', 'تشغيلي / Operational'), ('SUPPORT', 'دعم / Support')], default='ACADEMIC', max_length=20, verbose_name='نوع مركز التكلفة / Cost Center Type')),
                ('is_active', models.BooleanField(default=True, verbose_name='نشط / Active')),
                ('manager_name', models.CharField(blank=True, max_length=200, verbose_name='اسم المدير / Manager Name')),
                ('manager_phone', models.CharField(blank=True, max_length=20, verbose_name='هاتف المدير / Manager Phone')),
                ('annual_budget', models.DecimalField(decimal_places=2, default=0, max_digits=15, verbose_name='الميزانية السنوية / Annual Budget')),
                ('monthly_budget', models.DecimalField(decimal_places=2, default=0, max_digits=15, verbose_name='الميزانية الشهرية / Monthly Budget')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_percent', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=5, validators=[django.core.validators.MinValueValidator(Decimal('0')), django.core.validators.MaxValueValidator(Decimal('100'))], verbose_name='نسبة الخصم % / Discount Percent')),
                ('discount_amount', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0'))], verbose_name='قيمة الخصم الثابت / Fixed Discount Amount')),
                ('description', models.TextField(blank=True, verbose_name='الوصف / Description')),
                ('is_active', models.BooleanField(default=True, verbose_name='نشط / Active')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_percent', models.DecimalField(decimal_places=2, default=0, max_digits=5, verbose_name='نسبة الخصم % / Discount Percent')),
                ('discount_amount', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='قيمة الخصم / Discount Amount')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost_center', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='accounts', to='accounts.costcenter', verbose_name='مركز التكلفة / Cost Center')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('closed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='closed_periods', to=settings.AUTH_USER_MODEL, verbose_name='أُقفل بواسطة / Closed By')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('cost_center', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='courses', to='accounts.costcenter', verbose_name='مركز التكلفة / Cost Center')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entry_type', models.CharField(choices=[('MANUAL', 'يدوي / Manual'), ('enrollment', 'تسجيل / enrollment'), ('PAYMENT', 'دفع / Payment'), ('COMPLETION', 'إكمال / Completion'), ('EXPENSE', 'مصروف / Expense'), ('SALARY', 'راتب / Salary'), ('ADVANCE', 'سلفة / Advance'), ('ADJUSTMENT', 'تسوية / Adjustment')], default='MANUAL', max_length=20, verbose_name='نوع القيد / Entry Type')),
                ...
                ('posted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posted_entries', to=settings.AUTH_USER_MODEL, verbose_name='مُرحل بواسطة / Posted By')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost_center', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.costcenter', verbose_name='مركز التكلفة / Cost Center')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='أُنشئ بواسطة / Created By')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='أُنشئ بواسطة / Created By')),
                ('employee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='advances', to='employ.employee', verbose_name='الموظف / Employee')),
