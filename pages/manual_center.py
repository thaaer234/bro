...
MANUAL_CHAPTERS = [
    ...
    },
    {
        ...
        "steps": [
            ...
            "استخدم البطاقات التوضيحية والروابط المباشرة لفهم الأقسام الأساسية قبل الدخول إلى التفاصيل.",
            "إذا كنت على الجوال استخدم زر القائمة الدائري أعلى اليمين لفتح وإغلاق الشريط الجانبي.",
            "للوصول السريع يمكنك الاعتماد على القائمة الجانبية وروابط التنقل المباشرة داخل كل شاشة.",
        ],
        "focus_pages": [
