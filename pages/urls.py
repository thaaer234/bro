...
urlpatterns = [
    ...
    path('user-guide/handbook/', views.UserGuideHandbookView.as_view(), name='user_guide_handbook'),
    path('manual-center/', views.ManualCenterView.as_view(), name='manual_center'),
    path('manual-center/handbook/', views.ManualCenterHandbookView.as_view(), name='manual_center_handbook'),
