...
urlpatterns = [
    ...
    path('reception-daily-report/', login_required(views.ReceptionDailyReportView.as_view()), name='reception_daily_report'),
    path('employee-daily-report/', views.EmployeeDailyReportView.as_view(), name='employee_daily_report'),
    path('employee-daily-reports/', views.DailyReportListView.as_view(), name='employee_daily_reports'),
    path('employee-daily-report/print/<int:report_id>/', views.DailyReportPrintView.as_view(), name='employee_daily_report_print'),
